				...
				<Card className="card big">
					...
					<Form>
						<Space>
							...
							<LoginInput className={idError && "error"} placeholder="아이디를 입력하세요" id="id" type="text" onChange={(e) => setIdentifier(e.target.value)} />
							{idError && <div className="error_caption">올바른 아이디를 입력해 주세요</div>}
						</Space>
						<Space>
							<Label htmlFor="pwd">비밀번호</Label>
							<LoginInput className={psdError && "error"} placeholder="비밀번호를 입력하세요" id="pwd" type="password" onChange={(e) => setPassword(e.target.value)} />
							{psdError && <div className="error_caption">올바른 비밀번호를 입력해주세요.</div>}
						</Space>
						<Space className="btn">

export const teamData = [
	{
		...
		position: "FE",
		thought:
			" 메인 프로젝트 시작전에는 남들에 비해 따라가지 못해 개발이 더딜까봐  불안감이 있었지만 팀원들이 너무 좋고 으쌰으쌰하는 분위기라 항상까지는 아니지만 즐겁게 작업하고 있습니다 😀 리덕스 툴킷을 쓰면서 아직 어려운 부분도 있지만 비동기가 아닌 상태관리에서는 잘쓰고 있습니다 간단한 CRUD 부분만 맡았지만 막상 구현해보니 생각하지도 못한 부분에서 에러가 났지만 소통하여 같이 해결해 나가고 백엔드 쪽에서 실시간으로 어떤 에러가 뜨는지 실시간으로 알려 주실 정도로 협업이 잘되고 이게 진정한 협업이 아닐까 생각 합니다 맑고 고인물 즐겁다✨",
		worklog: [
		...
		theme: "blue",
		imgSrc_sm: "/images/readme/소라_sm.png",
		imgSrc_big: "/images/readme/소라_big.png",
	},
	{
		name: "손수빈",
		position: "FE",
		...
		theme: "red",
		imgSrc_sm: "/images/readme/수빈_sm.jpeg",
		imgSrc_big: "/images/readme/수빈_big.png",
	},
	{
		name: "신나현",
		position: "FE",
		imgSmall: "images/readme/나현_sm.jpg",
		imgBig: "images/readme/나현_big.png",
		thought:
		...
		theme: "pink",
		imgSrc_sm: "/images/readme/나현_sm.jpg",
		imgSrc_big: "/images/readme/나현_big.png",
	},
	{
		name: "신대경",
		position: "BE",
		...
		theme: "yellow",
		imgSrc_sm: "/images/readme/대경_sm.png",
		imgSrc_big: "/images/readme/대경_big.png",
	},
	{
		name: "양건모",
		position: "BE",
		thought:
			"메인 프로젝트를 시작하기 전에는 기획부터 시작해서 모든 것을 스스로 해야했기 때문에 막막함이 있었습니다. 하지만 좋은 팀원들을 만난 덕분에 많이 배우면서 맡은 부분을 수행할 수 있게 되었습니다. 구현해 낼 수 있을까라는 의문이 드는 기능을 해내면서 개발의 짜릿함을 느꼈고 이 경험은 앞으로 실무를 하는데 있어서 큰 도움이 될 것 같습니다. 서로 문제가 생겼을 때마다 공유하며 문제를 해결해 나가는 과정에서 협업이란 무엇인지 깨닫게 되었고 소통과 분위기가 너무 잘되고 좋은 팀원들 덕분에 프로젝트를 잘 마무리 할 수 있었습니다.",
		worklog: [
			"스토리 게시판 CRUD 구현",
		...
		theme: "blue",
		imgSrc_sm: "/images/readme/건모_sm.jpg",
		imgSrc_big: "/images/readme/건모_big.jpg",
	},
	{
		name: "조대희",
		position: "BE",
		thought:
			"즐겁다! 저희 팀의 모토가 아닐까 싶습니다. 팀의 분위기가 언제나 밝고 의욕이 넘쳐났기에 즐겁고 파이팅넘치게 팀 활동을 이어나갈 수 있었고.서로의 어려움과 어쩔수 없이 생겨나는 갈등을 서로가 도와가며 해결해나가는 저희 팀을 보며'어디까지나 혼자 하는 것이 편하다'라는 제 생각의 틀을 깰 수 있었던 게 이번 프로젝트를 하며 가장 크게 얻어 가는 것이라고 생각합니다. 팀의 리더가 됐음에도 미숙한 점이 많아 걱정이 앞섰는데 제네럴 부팀장 소라님, 꼼꼼한 서기 나현님, 즐겁다의 인격화 수빈님,백엔드 해결사 대경님, 영원한 듀오 건모님 모두가 있어 프로젝트를 잘 마무리할 수 있었습니다. 여러 SNS에서 사용되는 회원의 기능과 Security 등을 구현하며 얻은 개발적인 지식 뿐만 아니라 팀 활동의 긍정적인 영향까지 모두를 얻어 갈 수 있었던 프로젝트였기에 다시 한번 팀원분들에게 감사드리고 이런 경험을 잘 녹여내어 어떤 팀이든 잘 적응하는 사람이 될 수 있도록 증진하도록 하겠습니다!",
		worklog: [
		...
		theme: "red",
		imgSrc_sm: "/images/readme/대희_sm.jpg",
		imgSrc_big: "/images/readme/대희_big.jpg",
	},
];
